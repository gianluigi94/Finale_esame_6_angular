 ...
 */
export function isCatalogoHome(url: string): boolean { // funzione che mi dice se l'url è esattamente la home del catalogo
  return pulisciUrl(url) === '/catalogo'; // confronto l'url pulito con '/catalogo'
}
